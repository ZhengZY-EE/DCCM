...
mpiexec -n 8 python scripts/image_sample.py --batch_size 16 --training_mode consistency_distillation --sampler multistep --ts 0,17,39 --steps 40 --model_path ./model/cd_bedroom256_lpips.pt --attention_resolutions 32,16,8 --class_cond False --use_scale_shift_norm False --dropout 0.0 --image_size 256 --num_channels 256 --num_head_channels 64 --num_res_blocks 2 --num_samples 32 --resblock_updown True --use_fp16 False --weight_schedule uniform
